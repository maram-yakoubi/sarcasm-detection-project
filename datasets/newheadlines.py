# -*- coding: utf-8 -*-
"""Sarcasm Detection - News Headlines Dataset"""
...
# ----------------------------
print("\n" + "="*80)
print("NEWS HEADLINES DATASET - SARCASM DETECTION")
print("="*80)

# Load dataset
df = pd.read_csv('/kaggle/input/news-headlines-dataset-for-sarcasm-detection/Sarcasm_Headlines_Dataset.csv')
...
training_args = TrainingArguments(
    output_dir="./distilbert-news-headlines",
    num_train_epochs=2,
