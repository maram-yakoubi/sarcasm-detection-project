# -*- coding: utf-8 -*-
"""Sarcasm Detection - Tweets (SemEval) Dataset with IFM"""
...
# ----------------------------
print("\n" + "="*80)
print("TWEETS (SEMEVAL) DATASET - SARCASM DETECTION")
print("="*80)

# Load dataset - adjust path as needed
df = pd.read_csv('/kaggle/input/tweets-with-sarcasm-and-irony/tweets.csv')
df = df.rename(columns={"tweet": "text"})
df['label'] = df['sarcasm'].map({'sarcastic': 1, 'not sarcastic': 0})
...
# ----------------------------
print("\n" + "="*80)
print("FINAL RESULTS - TWEETS DATASET")
print("="*80)
